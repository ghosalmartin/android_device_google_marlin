...
BOARD_KERNEL_CMDLINE := androidboot.hardware=marlin user_debug=31 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=32M@0-0xffffffff loop.max_part=7 audit=0 selinux=0
